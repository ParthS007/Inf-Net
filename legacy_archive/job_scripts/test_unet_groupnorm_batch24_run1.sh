#!/bin/bash
#SBATCH --job-name=test_unet_groupnorm_batch24_run1
#SBATCH --output=logs/test/test_unet_groupnorm_batch24_run1_%j.out
#SBATCH --error=logs/test/test_unet_groupnorm_batch24_run1_%j.err
